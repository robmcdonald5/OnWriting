...
- Type `@` followed by the agent name (e.g., `@python-developer`)
...
- `python-developer` - Python code with best practices
- `pytest-developer` - Comprehensive test suites
- `pydantic-developer` - Data validation models
- `langchain-developer` - LangChain agent systems
- `langgraph-developer` - Multi-agent workflows
- `langsmith-developer` - Observability and debugging
- `fastapi-developer` - REST API development

### Research Agents (Documentation & Best Practices)
- `python-researcher` - Python best practices
- `langchain-researcher` - LangChain documentation
- `langgraph-researcher` - LangGraph patterns
- `sveltekit-researcher` - SvelteKit best practices
- `typescript-nodejs-researcher` - TypeScript/Node.js guidance
